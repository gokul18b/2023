...
public class ApiController {
	...
	public String member_register(@PathVariable String firstname,
		...
		dao.add_agent(firstname,lastname,dob,gender,emailid,mobile,age,state,city,pincode,address,profession,expierence,password);
	...
	@PostMapping("/policy_register/{name}/{category}/{period}/{premium}/{date}/"
			+ "{expierydate}/{amount}")
	public String add_policy(@PathVariable String name,
			@PathVariable String category,
			@PathVariable String  period,
			@PathVariable String premium,
			@PathVariable String date,
			@PathVariable String expierydate,
	...
	@PostMapping("/add_customer/{fname}/{lname}/{dob}/{mobile}/{age}/"
			+ "{gender}/{state}/{city}/{pincode}/{address}")
	public String add_customer(@PathVariable String fname,
			...
			@PathVariable String pincode,
			@PathVariable String address) {
		dao.add_customer(fname,lname,dob,mobile,age,gender,state,city,pincode,address);
		return "Policy Register Sucessfully";
	}
	
	@PostMapping("/add_payment/{policy_id}/{number}/{expdate}/{amount}")
	public String add_payment(@PathVariable String policy_id,
